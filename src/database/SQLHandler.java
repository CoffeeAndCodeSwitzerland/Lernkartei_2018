...
public abstract class SQLHandler {
	 ...
	 * @throws Exception 
	 */
	public static String toWhereClause(AttributeList attributes) throws Exception {
	...
	public static String toWhereClause(String name, String value, Datatype dType, String key, String val) throws Exception {
	...
	public static String toWhereClause(String name, String value, Datatype dType, String key, int val) throws Exception {
		AttributeList attributes = new AttributeList();
		Attribute a = new Attribute(name, value, dType);
		attributes.addUnique(a);
		a = new Attribute(key, val);
	...
	public static String toWhereClause(String name, String value, Datatype dType) throws Exception {
		AttributeList attributes = new AttributeList();
		Attribute a = new Attribute(name, value, dType);
		attributes.addUnique(a);
		return toWhereClause(attributes);
	...
	public static String toWhereClause(String pkeyName, String pkeyValue) throws Exception {
		AttributeList attributes = new AttributeList();
	...
	public static String toWhereClause(String pkeyName, String pkeyValue, String key2, String val2) throws Exception {
		AttributeList attributes = new AttributeList();
		PrimaryKey pk = new PrimaryKey(pkeyName, pkeyValue);
		attributes.addUnique(pk);
	...
	public static String toWhereClause(String pkeyName, String pkeyValue, String key2, int val2) throws Exception {
		AttributeList attributes = new AttributeList();
		PrimaryKey pk = new PrimaryKey(pkeyName, pkeyValue);
		attributes.addUnique(pk);
		Attribute key = new Attribute(key2, val2);
	 ...
	 * @throws Exception 
	 */
	public static String createTableIfNotExistsCommand(String tableName, AttributeList attributes) throws Exception {
		if (tableName != null && attributes != null && !tableName.equals("")) {
			...
			if (!attrList.equals(""))
				...
				throw new Exception ("empty data for update! " +tableName);
		} else {
			throw new Exception ("invalid data for update! "+ tableName);
		}
	}
	 ...
	 * @throws Exception 
	 */
	public static String deleteEntryCommand(String tableName, String keyName, String keyValue, Datatype dType) throws Exception {
	...
	public static String deleteEntryCommand(String tableName, String pkeyName, String pkeyValue) throws Exception {
		return deleteEntryCommand(tableName, pkeyName, pkeyValue, Datatype.PKEY);
	}

	public static String deleteEntryCommand(String tableName, String pkeyName, int pkeyValue) throws Exception {
	...
	public static String updateInTableCommand(	String tabName, AttributeList attributes, 
												Attribute keyAttribute) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public static String insertIntoTableCommand(String tabName, AttributeList attributes) throws Exception {
	...
	public static String insertIntoTableCommand(String tabName, AttributeList attributes, String att1, String val1, String att2, String val2) throws Exception {
...
//
	 ...
	 * @throws Exception 
	 */
	public static String selectCommand(String tabName, AttributeList restultAttributes) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public static String selectCommand(String tabName, AttributeList attributes, Attribute key1, Attribute key2) throws Exception {
		if (tabName != null && !tabName.equals("")) {
			// TODO handle cases with DISTINCT
			if (attributes != null) {
...
*/
	public static String selectCommand(String tabName, String seekKeyName, String seekKeyValue) throws Exception {
...
*/
	public static String selectCommand(String tabName, String returnKey, String seekKeyName, String seekKeyValue) throws Exception {
		AttributeList aList = new AttributeList();
		if (returnKey != null) {
			Attribute ra = new Attribute (returnKey);
			aList.addUnique(ra);
	...
	public static String selectCommand(	String tabName, String returnKey, String seekKeyName, 
										String seekKeyValue, String key2, String val2) throws Exception {
		AttributeList aList = new AttributeList();
		if (returnKey != null) {
			Attribute ra = new Attribute (returnKey);
			aList.addUnique(ra);
